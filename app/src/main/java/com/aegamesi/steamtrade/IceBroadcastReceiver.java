...
//This should still be good. Figure out disconnect issue.
	...
	public void onReceive(Context context, Intent intent) {
		if (Objects.equals(intent.getAction(), ConnectivityManager.CONNECTIVITY_ACTION)) {
			...
			if (SteamService.singleton == null || SteamService.singleton.steamClient == null ||
					SteamService.singleton.steamClient.getConnectedUniverse() == null || SteamService.singleton.steamClient.getConnectedUniverse()
					== EUniverse.Invalid) {
