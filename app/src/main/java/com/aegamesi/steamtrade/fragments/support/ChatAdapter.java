...
public class ChatAdapter extends CursorRecyclerAdapter<ChatAdapter.ViewHolder> implements OnLongClickListener {
	...
	public void onBindViewHolder(ChatAdapter.ViewHolder holder, Cursor cursor) {
		...
		// coloring
		int colorOffline = holder.itemView.getResources().getColor(R.color.steam_offline, null);
		...
		if (compact) {
			...
			bubbleParams.gravity = column_sent_by_us ? Gravity.END : Gravity.START;
	...
	class ViewHolder extends RecyclerView.ViewHolder {
		...
		private ViewHolder(ViewGroup parent) {
			...
			textMessage = itemView.findViewById(R.id.chat_message);
			if (!compact) {
